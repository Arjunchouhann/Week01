import java.util.*;
//Create TravelComputation Class to compute all the travel
public class TravelComputation{  
	public static void main(String[] args) {
		Scanner input = new Scanner(System.in);
		System.out.println("Enter name: ");
		String name = input.nextLine();
		// Create variables fromCity, viaCity and toCity indicating city fromcity, viacity and tocity 
		...
		// this variable show the time in minutes to travel taken to travel fromCity to viaCity in minutes 
		...
		// Create a variable to indicate the total time taken to travel from fromCity to toCity in minutes 
